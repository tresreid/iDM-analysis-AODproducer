...
#SAMPLEDIR="/uscms/home/mreid/nobackup/ggF/ggF/"
SAMPLEDIR="/uscms/home/mreid/nobackup/MiniAODProd_ggF/iDM-analysis-AODproducer/LHEs"

HADRONIZER="ggF_externalLHEProducer_and_PYTHIA8_Hadronizer"
export BASEDIR=`pwd`
...
file_list=`ls ${SAMPLEDIR}/*.lhe | sed "s|^|${SAMPLEDIR}|"`
...
for ctau_mm in 100000 #1000000 10000000 100000000
# 100 1000
#for ctau_mm in 10
do
